        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              <img src="{{$player->photo ? asset('storage/'. $player->photo) : asset('storage/photos/no-photo.jpg')}}" alt="{{$player->name}}"
                class="rounded-circle img-fluid" style="width: 150px;">
              <h5 class="my-3">{{$player->name}} | #{{$player->number}}</h5>
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <p class="text-muted mb-0">{{$player->birthdate}}</p>
                </div>
              </div>
              <hr>
            </div>
